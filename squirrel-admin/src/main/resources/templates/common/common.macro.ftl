...
<#macro commonHeader>
    <header class="main-header">
        <a href="${request.contextPath}/" class="logo">
            <span class="logo-mini"><b></b>Squirrel</span>
            <span class="logo-lg"><b></b>人力资源管理系统</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            欢迎 ${Request["SQUIRREL_LOGIN_IDENTITY"].userName}
                    ...
                    <form class="form-horizontal form" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"><input type="text" class="form-control" name="password"
                                                          placeholder="请输入新密码" maxlength="100"></div>
                        </div>
                        <hr>
                        <div class="form-group">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <#if SQUIRREL_LOGIN_IDENTITY.type == 3>
                    <li class="nav-click <#if pageName == "userList">active</#if>"><a
                                href="${request.contextPath}/user"><i class="fa fa-circle-o text-red"></i>
                            <span>用户管理</span></a></li>
                    <li class="nav-click <#if pageName == "roleList">active</#if>"><a
                                href="${request.contextPath}/role"><i class="fa fa-circle-o text-red"></i>
                            <span>角色管理</span></a></li>
                    <li class="nav-click <#if pageName == "resumeList">active</#if>"><a
                                href="${request.contextPath}/resume"><i class="fa fa-circle-o text-red"></i>
                            <span>简历管理</span></a></li>
                <#else>
                    <li class="nav-click <#if pageName == "userList">active</#if>"><a
                                href="${request.contextPath}/user"><i class="fa fa-circle-o text-red"></i>
...
<#macro commonFooter >
    <footer class="main-footer">
        Powered by <b>Squirrel</b> 0.0.1-SNAPSHOT
